...
func selfRegistration(clientset *kubernetes.Clientset, caCert []byte) {
	...
	_, err := client.Get("elastic-toleration-webhook", metav1.GetOptions{})
	if err == nil {
		if err2 := client.Delete("elastic-toleration-webhook", nil); err2 != nil {
			glog.Fatal(err2)
		}
	}
	...
	webhookConfig := &v1beta1.MutatingWebhookConfiguration{
		ObjectMeta: metav1.ObjectMeta{
			Name: "elastic-toleration-webhook",
		},
